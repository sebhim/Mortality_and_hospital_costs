...
- Data quality of mortality data (Madea & Rothschild, 2010)
...
# Base model
CVD_reg <- lm(d_CVD_mort_100k ~ d_CVD_costs_100k + d_lag_CVD_costs_100k + year + gender, data = data, weights = population)
